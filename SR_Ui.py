    ...
    def model(self):
        ...
        if selected == "Flat resale_Prediction":
            ...
            with col2:
                ...
                source = {'CENTRAL_index': 0, 'EAST_index': 0, 'WEST_index': 0, 'SOUTH_index': 0, 'NORTH_index': 0}
                
                if region == 'CENTRAL':
                    source = {'CENTRAL_index': 1, 'EAST_index': 0, 'WEST_index': 0, 'SOUTH_index': 0, 'NORTH_index': 0}
                elif region == 'EAST':
                    source = {'CENTRAL_index': 0, 'EAST_index': 1, 'WEST_index': 0, 'SOUTH_index': 0, 'NORTH_index': 0}
                elif region == 'WEST':
                    source = {'CENTRAL_index': 0, 'EAST_index': 0, 'WEST_index': 1, 'SOUTH_index': 0, 'NORTH_index': 0}
                elif region == 'SOUTH':
                    source = {'CENTRAL_index': 0, 'EAST_index': 0, 'WEST_index': 0, 'SOUTH_index': 1, 'NORTH_index': 0}
                elif region == 'NORTH':
                ...
                predict_data = [source, number_of_rooms, storey, floor_area_sqm,
                                remaining_lease]

                with open('Sr2_regression.pkl', 'rb') as f:
                    model = pickle.load(f)
